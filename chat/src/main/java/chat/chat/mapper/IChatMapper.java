...
public interface IChatMapper {
    @Mappings(
        {
            @Mapping(
                source = "chatDTO.messageDTOs",
                target = "messageEntities"
            ),
            @Mapping(
                source = "chatDTO.chatUserDTOs",
                target = "chatUserEntities"
            ),
        }
    )
    ...
    @Mappings(
        {
            @Mapping(
                source = "chatEntity.messageEntities",
                target = "messageDTOs"
            ),
            @Mapping(
                source = "chatEntity.chatUserEntities",
                target = "chatUserDTOs"
            ),
        }
    )
